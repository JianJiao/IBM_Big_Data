 ...
 */
public class LearnBasicDirectedGraph {
    ...
    public LearnBasicDirectedGraph() {       
    }
    ...
    public void constructGraph() {
        ...
        n1 = new MyNode(1); n2 = new MyNode(9); n3 = new MyNode(3);  
        n4 = new MyNode(4); n5 = new MyNode(5); // note n1-n5 declared elsewhere.
        String strN1 = n1.toString();
        String strN2 = n2.toString();
        int n1Id = n1.getId();
        String n1Shape = n1.getShape();
        System.out.println("The shape of n1 is : " + n1Shape);
        n1.setShape("circle");
        n1Shape = n1.getShape();
        System.out.println("The shape of n1 now becomes : " + n1Shape);
        
        System.out.println("The id of n1 is : " + n1Id);
        System.out.println("This is n1: " + strN1);
        System.out.println("This is n2: " + strN2);
    ...
    public static void main(String[] args) {
        LearnBasicDirectedGraph myApp = new LearnBasicDirectedGraph();
